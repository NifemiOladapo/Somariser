...
const page = async (props: { params: Promise<{ id: string }> }) => {
    ...
    const { title, summary_text, file_name, word_count, created_at, original_file_url, status, updated_at, } = summary;
    const readingTime = Math.ceil((summary_text.length || 0) / 200);
    return (
        <div className="relative isolate min-h-screen bg-linear-to-b fron-rose-50/40 to-white">
            ...
            <div className="container mx-auto flex flex-col gap-4">
                <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
                    ...
                    {file_name && <SourceInfo fileName={file_name} originalFileUrl={original_file_url} createdAt={created_at} summaryText={summary_text} title={title} />}
