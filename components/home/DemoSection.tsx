      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        >
          <div
            ...
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 62.4% 42%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.3%, 27.5% 76.7%, 0.1% 64.9%, 1.7% 9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
          />
        </div> */}
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="text-center mb-16">
            <h3 className="font-bold text-3xl max-w-3xl mx-auto px-4 sm:px-6">
              Watch how Somariser transforms{" "}
