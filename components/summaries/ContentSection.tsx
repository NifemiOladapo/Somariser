...
const EmojiPoint = ({ index, point }: { index: number; point: string }) => {
    ...
    >
      <div
        className="absolute inset-0
          bg-linear-to-r from-gray-500/10 to-transparent
...
const RegularPoint = ({ index, point }: { point: string; index: number }) => {
  return (
    <div
      key={`point-${index}`}
      className="group relative bg-linear-to-br
